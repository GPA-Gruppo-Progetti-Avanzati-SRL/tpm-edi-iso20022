...
const (
	...
	ExternalClaimNonReceiptRejection1CodeSample    = "oJ"
...
const (
	...
	ExternalCategoryPurpose1CodeSample    = "nN"
...
const (
	...
	ExternalMandateSetupReason1CodeSample    = "PG"
...
const (
	...
	Exact4AlphaNumericTextSample = "o9sR"
)
...
const (
	...
	BICFIDec2014IdentifierSample = "311QOCJN"
)
...
const (
	...
	ExternalPaymentCompensationReason1CodeSample    = "si"
...
const (
	...
	ExternalDocumentType1CodeSample    = "uz"
...
const (
	...
	ExternalPaymentTransactionStatus1CodeSample    = "yt"
...
const (
	...
	ExternalOrganisationIdentification1CodeSample    = "MO"
...
const (
	Max2048TextZero      = ""
	Max2048TextSample    = ""
	Max2048TextLength    = 0
...
const (
	...
	ExternalCancellationReason1CodeSample    = "id"
...
const (
	Max70TextZero      = ""
	Max70TextSample    = "gAfEcoSKFvxTVCZoKMHuKFgkhaujRMxfcNG"
	Max70TextLength    = 0
...
const (
	...
	ExternalPersonIdentification1CodeSample    = "Dj"
...
const (
	...
	ExternalCashAccountType1CodeSample    = "kb"
...
const (
	Max34TextZero      = ""
	Max34TextSample    = "feENRdnZuYVnOFfaK"
	Max34TextLength    = 0
...
const (
	...
	ExternalDocumentLineType1CodeSample    = "gX"
...
const (
	...
	UUIDv4IdentifierSample = "721ec727-dc5e-4b6d-8534-295c75d372bd"
)
...
const (
	...
	ExternalPaymentModificationRejection1CodeSample    = "cx"
...
const (
	...
	ExternalAccountIdentification1CodeSample    = "fc"
...
const (
	...
	AnyBICDec2014IdentifierSample = "GNO3SFXG"
)
...
const (
	Max140TextZero      = ""
	Max140TextSample    = "uIkhdUMOniOqWYIJMqLchMkCJZHSenoYIFnHZyTzEfMSdhUvtMBlfUoZYLEdqkoZCuTuRp"
	Max140TextLength    = 0
...
const (
	...
	ExternalServiceLevel1CodeSample    = "LK"
...
const (
	Max105TextZero      = ""
	Max105TextSample    = "zzuuFjTKIOTjSnLTFioYayJwBotODVVVIrFCqrhOGVehnNZfARfsB"
	Max105TextLength    = 0
...
const (
	Max350TextZero      = ""
	Max350TextSample    = "VGBRaHjfFcQtXovQyXbjAyWbspgheqXXumwlaMkvqgeVNsLyylTpEsGuymNstQzxPbmXGYPZRoCcAjYwjicELciiQYDuPezahlBGYsXsQyazOWcrSbAuTepBSUGepQDYBzMBKXUbWscOLULiIiQtPiPomlXcvuojfHBHOQiGrmoSuel"
	Max350TextLength    = 0
...
const (
	LEIIdentifierZero   = ""
	LEIIdentifierSample = "8LV7YAPD6JK4REWNA203"
)
...
const (
	...
	ExternalLocalInstrument1CodeSample    = "NipGLXawNpUCRNoVMT"
...
const (
	...
	ExternalTaxAmountType1CodeSample    = "KO"
...
const (
	...
	ExternalChargeType1CodeSample    = "Gg"
...
const (
	...
	Max15NumericTextSample = "9106686367"
)
...
const (
	...
	ExternalDiscountAmountType1CodeSample    = "xN"
...
const (
	...
	ExternalDocumentFormat1CodeSample    = "QP"
...
const (
	...
	ExternalStatusReason1CodeSample    = "pR"
...
const (
	...
	ExternalFinancialInstitutionIdentification1CodeSample    = "iW"
...
const (
	...
	IBAN2007IdentifierSample = "BR51ebxf"
)
...
const (
	...
	ExternalInvestigationExecutionConfirmation1CodeSample    = "LB"
...
const (
	...
	ExternalPaymentCancellationRejection1CodeSample    = "lM"
...
const (
	...
	ExternalPaymentGroupStatus1CodeSample    = "Zx"
...
const (
	...
	ExternalProxyAccountType1CodeSample    = "cx"
...
const (
	Max128TextZero      = ""
	Max128TextSample    = "WxtuKOMWJPKLdPagMDpbVTfGYQeuDWBbAsCNeGzZKpmgINTkianyMbMixyxcPQjM"
	Max128TextLength    = 0
...
const (
	...
	ActiveOrHistoricCurrencyCodeSample = "MMV"
)
...
const (
	...
	ExternalGarnishmentType1CodeSample    = "CS"
...
const (
	...
	ExternalClearingSystemIdentification1CodeSample    = "HCD"
...
const (
	Max1025TextZero      = ""
	Max1025TextSample    = ""
	Max1025TextLength    = 0
...
const (
	Max35TextZero      = ""
	Max35TextSample    = "xKEqjfuCczVQirHYgx"
	Max35TextLength    = 0
...
const (
	...
	ExternalCashClearingSystem1CodeSample    = "pG"
