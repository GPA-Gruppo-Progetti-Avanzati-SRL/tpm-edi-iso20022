...
const (
	...
	ExternalDocumentFormat1CodeSample    = "nN"
...
const (
	...
	ExternalClearingSystemIdentification1CodeSample    = "PGs"
...
const (
	Max2048TextZero      = ""
	Max2048TextSample    = ""
	Max2048TextLength    = 0
...
const (
	LEIIdentifierZero   = ""
	LEIIdentifierSample = "D2C9I7801HZ9I8QE8W22"
)
...
const (
	Max350TextZero      = ""
	Max350TextSample    = "fSJWCidgAfEcoSKFvxTVCZoKMHuKFgkhaujRMxfcNGDjkbfeENRdnZuYVnOFfaKgXcxfcXVutzuIkhdUMOniOqWYIJMqLchMkCJZHSenoYIFnHZyTzEfMSdhUvtMBlfUoZYLEdqkoZCuTuRpLKzzuuFjTKIOTjSnLTFioYayJwBotOD"
	Max350TextLength    = 0
...
const (
	...
	AnyBICDec2014IdentifierSample = "5DR7OQ7JME4"
)
...
const (
	...
	IBAN2007IdentifierSample = "CL78bRX"
)
...
const (
	...
	ExternalDocumentType1CodeSample    = "VI"
...
const (
	Max35TextZero      = ""
	Max35TextSample    = "rFCqrhOGVehnNZfARf"
	Max35TextLength    = 0
...
const (
	...
	BICFIDec2014IdentifierSample = "IIHGCURF"
)
...
const (
	...
	ActiveOrHistoricCurrencyCodeSample = "IQX"
)
...
const (
	...
	ExternalProxyAccountType1CodeSample    = "Ra"
...
const (
	...
	ExternalDocumentLineType1CodeSample    = "Hj"
...
const (
	...
	ExternalCategoryPurpose1CodeSample    = "fF"
...
const (
	...
	ExternalTaxAmountType1CodeSample    = "cQ"
...
const (
	Max128TextZero      = ""
	Max128TextSample    = "tXovQyXbjAyWbspgheqXXumwlaMkvqgeVNsLyylTpEsGuymNstQzxPbmXGYPZRoC"
	Max128TextLength    = 0
...
const (
	Max70TextZero      = ""
	Max70TextSample    = "cAjYwjicELciiQYDuPezahlBGYsXsQyazOW"
	Max70TextLength    = 0
...
const (
	...
	ExternalAccountIdentification1CodeSample    = "cr"
...
const (
	...
	ExternalPersonIdentification1CodeSample    = "Sb"
...
const (
	...
	Exact4AlphaNumericTextSample = "pyZO"
)
...
const (
	...
	ExternalServiceLevel1CodeSample    = "Au"
...
const (
	Max140TextZero      = ""
	Max140TextSample    = "pQDYBzMBKXUbWscOLULiIiQtPiPomlXcvuojfHBHOQiGrmoSuelNipGLXawNpUCRNoVMTK"
	Max140TextLength    = 0
...
const (
	Max34TextZero      = ""
	Max34TextSample    = "OGgxNQPpRiWmNuFOP"
	Max34TextLength    = 0
...
const (
	...
	UUIDv4IdentifierSample = "ab45c2e8-e26e-45e8-a14b-a37d7afe1a67"
)
...
const (
	...
	ExternalGarnishmentType1CodeSample    = "ct"
...
const (
	...
	ExternalOrganisationIdentification1CodeSample    = "LB"
...
const (
	...
	ExternalLocalInstrument1CodeSample    = "lMZxcxWxtuKOMWJPKL"
...
const (
	...
	ExternalCashAccountType1CodeSample    = "dP"
...
const (
	...
	ExternalDiscountAmountType1CodeSample    = "ag"
