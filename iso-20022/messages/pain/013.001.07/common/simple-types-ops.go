...
const (
	...
	UUIDv4IdentifierSample = "ea4bdb62-d547-40eb-9411-57ffa0886fe9"
)
...
const (
	...
	AnyBICDec2014IdentifierSample = "P07IXKLC"
)
...
const (
	...
	ExternalDocumentType1CodeSample    = "oJ"
...
const (
	Max350TextZero      = ""
	Max350TextSample    = "nNPGsiuzytMOJPatwtPilfsfykSBGplhxtxVSGpqaJaBRgAvzLXqzRrrUIYvaIujDpHYjxeUBrVfdwUzWHRihFDPRHBMuEWmaNvhHLITWJcJKzJsRPeJbpTqWPUlWAcidRlufmYWddEktBDrWMYZTPdmDAVCuvQutLDKFBGRxnyDNYu"
	Max350TextLength    = 0
...
const (
	...
	ExternalTaxAmountType1CodeSample    = "RK"
...
const (
	...
	ExternalClearingSystemIdentification1CodeSample    = "Wsm"
...
const (
	Max35TextZero      = ""
	Max35TextSample    = "ZnOYgSLPSsuMMmvYma"
	Max35TextLength    = 0
...
const (
	...
	ExternalProxyAccountType1CodeSample    = "FE"
...
const (
	Max140TextZero      = ""
	Max140TextSample    = "jLgSvndTeranxGMNCcCdlEBYqxqrgAieJuFVZUsgPmweLRmsdTIwtLUDqoBSNtPRViLXLC"
	Max140TextLength    = 0
...
const (
	...
	ExternalServiceLevel1CodeSample    = "rS"
...
const (
	...
	ExternalCategoryPurpose1CodeSample    = "AZ"
...
const (
	...
	ExternalAccountIdentification1CodeSample    = "Cj"
...
const (
	...
	ExternalFinancialInstitutionIdentification1CodeSample    = "xT"
...
const (
	Max128TextZero      = ""
	Max128TextSample    = "CaZnfHRhEbbvlLkCbvOlRrOWJFNwNQBqyozKVGeninyrTgqubNiIzWcEZsdyUJTD"
	Max128TextLength    = 0
...
const (
	...
	ExternalGarnishmentType1CodeSample    = "Kc"
...
const (
	...
	IBAN2007IdentifierSample = "KD86fTdmkmcR"
)
...
const (
	LEIIdentifierZero   = ""
	LEIIdentifierSample = "GBFAX4ITIS9WIF1S2V43"
)
...
const (
	...
	ExternalCashAccountType1CodeSample    = "Tq"
...
const (
	...
	ExternalDocumentFormat1CodeSample    = "ZT"
...
const (
	...
	ExternalPersonIdentification1CodeSample    = "ha"
...
const (
	...
	ExternalLocalInstrument1CodeSample    = "mRVAClOEaCEmEUmEtN"
...
const (
	...
	BICFIDec2014IdentifierSample = "CALACUR2"
)
...
const (
	...
	ExternalOrganisationIdentification1CodeSample    = "tQ"
...
const (
	...
	Exact4AlphaNumericTextSample = "Zm77"
)
...
const (
	...
	ExternalDiscountAmountType1CodeSample    = "DB"
...
const (
	Max70TextZero      = ""
	Max70TextSample    = "VyDFfPWGaZQntPiyJbzjrRNLRzGpzDszPvw"
	Max70TextLength    = 0
...
const (
	...
	ActiveOrHistoricCurrencyCodeSample = "JJF"
)
...
const (
	...
	ExternalDocumentLineType1CodeSample    = "eG"
...
const (
	Max34TextZero      = ""
	Max34TextSample    = "xRQcoxpAQxuFkaowC"
	Max34TextLength    = 0
...
const (
	Max2048TextZero      = ""
	Max2048TextSample    = ""
	Max2048TextLength    = 0
