...
const (
	...
	BICFIDec2014IdentifierSample = "6II3ZGRZ"
)
...
const (
	...
	ExternalDocumentLineType1CodeSample    = "Gs"
...
const (
	...
	ExternalGarnishmentType1CodeSample    = "iu"
...
const (
	...
	ActiveOrHistoricCurrencyCodeSample = "VID"
)
...
const (
	LEIIdentifierZero   = ""
	LEIIdentifierSample = "ECRUDS5TLHR3HH36XY87"
)
...
const (
	...
	Max15NumericTextSample = "50818539"
)
...
const (
	...
	ExternalDocumentType1CodeSample    = "zy"
...
const (
	...
	ExternalFinancialInstitutionIdentification1CodeSample    = "tM"
...
const (
	...
	ExternalClearingSystemIdentification1CodeSample    = "ilf"
...
const (
	...
	ExternalServiceLevel1CodeSample    = "sf"
...
const (
	...
	Exact4AlphaNumericTextSample = "7dQg"
)
...
const (
	...
	AnyBICDec2014IdentifierSample = "6GM0AW6S"
)
...
const (
	...
	ExternalAccountIdentification1CodeSample    = "yk"
...
const (
	...
	ExternalOrganisationIdentification1CodeSample    = "SB"
...
const (
	Max128TextZero      = ""
	Max128TextSample    = "GplhxtxVSGpqaJaBRgAvzLXqzRrrUIYvaIujDpHYjxeUBrVfdwUzWHRihFDPRHBM"
	Max128TextLength    = 0
...
const (
	Max34TextZero      = ""
	Max34TextSample    = "uEWmaNvhHLITWJcJK"
	Max34TextLength    = 0
...
const (
	Max140TextZero      = ""
	Max140TextSample    = "sRPeJbpTqWPUlWAcidRlufmYWddEktBDrWMYZTPdmDAVCuvQutLDKFBGRxnyDNYuRKWsmZ"
	Max140TextLength    = 0
...
const (
	...
	ExternalLocalInstrument1CodeSample    = "nOYgSLPSsuMMmvYmaF"
...
const (
	...
	ExternalDocumentFormat1CodeSample    = "Ej"
...
const (
	...
	ExternalDiscountAmountType1CodeSample    = "Lg"
...
const (
	...
	ExternalCategoryPurpose1CodeSample    = "Sv"
...
const (
	...
	ExternalCashAccountType1CodeSample    = "nd"
...
const (
	...
	ExternalPersonIdentification1CodeSample    = "Te"
...
const (
	Max2048TextZero      = ""
	Max2048TextSample    = ""
	Max2048TextLength    = 0
...
const (
	...
	ExternalTaxAmountType1CodeSample    = "Ra"
...
const (
	...
	ExternalProxyAccountType1CodeSample    = "fF"
...
const (
	Max35TextZero      = ""
	Max35TextSample    = "cQtXovQyXbjAyWbspg"
	Max35TextLength    = 0
...
const (
	Max70TextZero      = ""
	Max70TextSample    = "heqXXumwlaMkvqgeVNsLyylTpEsGuymNstQ"
	Max70TextLength    = 0
...
const (
	Max350TextZero      = ""
	Max350TextSample    = "zxPbmXGYPZRoCcAjYwjicELciiQYDuPezahlBGYsXsQyazOWcrSbAuTepBSUGepQDYBzMBKXUbWscOLULiIiQtPiPomlXcvuojfHBHOQiGrmoSuelNipGLXawNpUCRNoVMTKOGgxNQPpRiWmNuFOPctLBlMZxcxWxtuKOMWJPKLdPag"
	Max350TextLength    = 0
...
const (
	...
	UUIDv4IdentifierSample = "8be31729-0962-4af7-9e40-1c6347788a2c"
)
...
const (
	...
	IBAN2007IdentifierSample = "XT24f"
)
