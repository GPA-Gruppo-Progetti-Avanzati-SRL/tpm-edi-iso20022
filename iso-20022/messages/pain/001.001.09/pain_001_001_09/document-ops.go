...
func (d *Document) ClearPath(p string, opts ...SetOpOption) error {
	...
	const semLogContext = "pain_001_001_09::clear-path"
...
func (d *Document) GetProperty(path string, opts ...GetOpOption) (interface{}, error) {
	...
	const semLogContext = "pain_001_001_09::get-property"
...
func copy2Dest(docPath string, dest, src interface{}, options *SetOpOptions) error {
	...
	case *common.ExchangeRateType1Code:
		...
		if options.isClearOperation {
			*typedDest = common.ExchangeRateType1CodeZero
		} else {
	...
	case *common.PaymentMethod3Code:
		...
		if options.isClearOperation {
			*typedDest = common.PaymentMethod3CodeZero
		} else {
