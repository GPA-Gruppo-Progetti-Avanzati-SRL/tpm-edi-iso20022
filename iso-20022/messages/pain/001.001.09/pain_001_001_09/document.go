...
const (
	Iso20022MsgName = "pain.001.001.09"
)
...
type Document struct {
	...
	CstmrCdtTrfInitn *CustomerCreditTransferInitiationV09 `xml:"CstmrCdtTrfInitn,omitempty"`
...
func (d Document) IsValid(optional bool) bool {
	...
	valid := true
	valid = valid && d.CstmrCdtTrfInitn != nil && d.CstmrCdtTrfInitn.IsValid(false)
