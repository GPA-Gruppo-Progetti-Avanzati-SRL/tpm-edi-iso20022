...
func copy2DestNode(docPath string, dest, src interface{}, options *SetOpOptions) error {
	...
	const semLogContext = "pain_008_001_08::copy-to-dest"
	...
	case **CreditorReferenceType2:
		...
		return err
	case **CustomerDirectDebitInitiationV08:
		if typedStruct, ok := src.(CustomerDirectDebitInitiationV08); ok {
			*typedDest = &typedStruct
		} else {
			err = fmt.Errorf("value of type %T cannot be assigned", src)
		}
	...
	case **DatePeriod2:
		...
		return err
	case **DirectDebitTransaction10:
		if typedStruct, ok := src.(DirectDebitTransaction10); ok {
			*typedDest = &typedStruct
		} else {
			err = fmt.Errorf("value of type %T cannot be assigned", src)
		}
	...
	case **GenericIdentification30:
		...
		return err
	case **GroupHeader83:
		if typedStruct, ok := src.(GroupHeader83); ok {
			*typedDest = &typedStruct
		} else {
			err = fmt.Errorf("value of type %T cannot be assigned", src)
		}
	...
	case **PaymentIdentification6:
		...
		return err
	case **PaymentTypeInformation29:
		if typedStruct, ok := src.(PaymentTypeInformation29); ok {
			*typedDest = &typedStruct
		} else {
			err = fmt.Errorf("value of type %T cannot be assigned", src)
		}
	...
	case *[]Authorisation1Choice:
		...
		return err
	case *DirectDebitTransactionInformation23:
		if typedStruct, ok := src.(DirectDebitTransactionInformation23); ok {
			*typedDest = typedStruct
		} else {
			err = fmt.Errorf("value of type %T cannot be assigned", src)
		}
	...
	case *[]OtherContact1:
		...
		return err
	case *PaymentInstruction29:
		if typedStruct, ok := src.(PaymentInstruction29); ok {
			*typedDest = typedStruct
		} else {
			err = fmt.Errorf("value of type %T cannot be assigned", src)
		}
...
func (d *Document) ClearNode(path string, opts ...SetOpOption) error {
	const semLogContext = "pain_008_001_08::clear-node"
