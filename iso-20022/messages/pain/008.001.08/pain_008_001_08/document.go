...
const (
	Iso20022MsgName = "pain.008.001.08"
)
...
type Document struct {
	XMLName           xml.Name                          `xml:"urn:iso:std:iso:20022:tech:xsd:pain.008.001.08 Document"`
	CstmrDrctDbtInitn *CustomerDirectDebitInitiationV08 `xml:"CstmrDrctDbtInitn,omitempty"`
...
func (d Document) IsValid(optional bool) bool {
	...
	valid := true
	valid = valid && d.CstmrDrctDbtInitn != nil && d.CstmrDrctDbtInitn.IsValid(false)
