...
const (
	...
	IBAN2007IdentifierSample = "ZH38a5"
)
...
const (
	Max140TextZero      = ""
	Max140TextSample    = "uzytMOJPatwtPilfsfykSBGplhxtxVSGpqaJaBRgAvzLXqzRrrUIYvaIujDpHYjxeUBrVf"
	Max140TextLength    = 0
...
const (
	...
	BICFIDec2014IdentifierSample = "EG0ASDEA"
)
...
const (
	...
	ExternalCategoryPurpose1CodeSample    = "dw"
...
const (
	...
	ExternalPersonIdentification1CodeSample    = "Uz"
...
const (
	...
	ExternalDocumentLineType1CodeSample    = "WH"
...
const (
	...
	ExternalProxyAccountType1CodeSample    = "Ri"
...
const (
	...
	ExternalAccountIdentification1CodeSample    = "hF"
...
/*
 * PaymentMethod2Code Ops
 */

const (
	PaymentMethod2CodeZero   = ""
	PaymentMethod2CodeSample = "DD"
	PaymentMethod2CodeDD     = "DD"
)

var PaymentMethod2CodeEnumRestriction = []string{PaymentMethod2CodeDD}

// IsValid checks if PaymentMethod2Code of type String is valid
func (t PaymentMethod2Code) IsValid(optional bool) bool {

	valid := xsdt.String(t).IsValid(optional)

	if optional && t == PaymentMethod2CodeZero {
		return valid
	}
	valid = valid && isEnumRestrictionValid(t.String(), PaymentMethod2CodeEnumRestriction)

	return valid
}

// String method for easy conversion
func (t PaymentMethod2Code) String() string {
	return string(t)
}

// ToPaymentMethod2Code method for easy conversion with application of restrictions
func ToPaymentMethod2Code(i interface{}) (PaymentMethod2Code, error) {
	...
	if !isEnumRestrictionValid(s, PaymentMethod2CodeEnumRestriction) {
		return "", fmt.Errorf("cannot satisfy enum restriction for %s of type PaymentMethod2Code", s)
	}

	return PaymentMethod2Code(s), nil
}

// MustToPaymentMethod2Code method for easy conversion with application of restrictions. Panics on error.
func MustToPaymentMethod2Code(s interface{}) PaymentMethod2Code {
	v, err := ToPaymentMethod2Code(s)
	if err != nil {
		panic(err)
	}
...
const (
	Max128TextZero      = ""
	Max128TextSample    = "DPRHBMuEWmaNvhHLITWJcJKzJsRPeJbpTqWPUlWAcidRlufmYWddEktBDrWMYZTP"
	Max128TextLength    = 0
...
const (
	Max34TextZero      = ""
	Max34TextSample    = "dmDAVCuvQutLDKFBG"
	Max34TextLength    = 0
...
const (
	Max1025TextZero      = ""
	Max1025TextSample    = ""
	Max1025TextLength    = 0
...
const (
	LEIIdentifierZero   = ""
	LEIIdentifierSample = "AFNZW70RJPDNIFQCA670"
)
...
const (
	...
	ExternalGarnishmentType1CodeSample    = "oM"
...
const (
	...
	ExternalClearingSystemIdentification1CodeSample    = "jxi"
...
const (
	Max350TextZero      = ""
	Max350TextSample    = "XcwedxkRvEookKzpacqgBiXejXjTJPhMQsmGzinFnyUVhVOydnINYczGVyZhBRwWAXjuufUoPJlNOFUvANpjrlwiuIbjJbgkIxMkImqLfMdmksNxvjgyEJAjrjcQDUlVTuFKDLjgBjrpEBlRzIZVSUAgxlZPBVcodWJbYmpBEprbxsR"
	Max350TextLength    = 0
...
const (
	...
	ExternalServiceLevel1CodeSample    = "nS"
...
const (
	...
	ExternalOrganisationIdentification1CodeSample    = "Fq"
...
const (
	...
	ExternalMandateSetupReason1CodeSample    = "RI"
...
const (
	...
	ExternalFinancialInstitutionIdentification1CodeSample    = "jO"
...
const (
	...
	ExternalDiscountAmountType1CodeSample    = "Na"
...
const (
	Max70TextZero      = ""
	Max70TextSample    = "xVzTtXlnbdWOKzddfZvtzFRwXkWBBNMmMfC"
	Max70TextLength    = 0
...
const (
	Max2048TextZero      = ""
	Max2048TextSample    = ""
	Max2048TextLength    = 0
...
const (
	...
	ActiveOrHistoricCurrencyCodeSample = "ECB"
)
...
const (
	Max35TextZero      = ""
	Max35TextSample    = "vjeIFqcbbyaToaaLLc"
	Max35TextLength    = 0
...
const (
	...
	Exact4AlphaNumericTextSample = "SbEl"
)
...
const (
	...
	ExternalLocalInstrument1CodeSample    = "zPeHYSnzubklHSaxZV"
...
const (
	PhoneNumberZero   = ""
	PhoneNumberSample = "+41-22(57(4723"
)
...
const (
	...
	UUIDv4IdentifierSample = "08e777d6-3037-4af0-a01d-d66504beebe9"
)
...
const (
	...
	ExternalTaxAmountType1CodeSample    = "dH"
...
const (
	...
	AnyBICDec2014IdentifierSample = "OXQ5NE9K36Y"
)
...
const (
	...
	ExternalCashAccountType1CodeSample    = "pp"
