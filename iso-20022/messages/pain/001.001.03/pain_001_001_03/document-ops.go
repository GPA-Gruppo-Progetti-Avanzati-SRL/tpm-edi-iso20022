...
func copy2Dest(docPath string, dest, src interface{}) error {
	...
	case *common.ExchangeRateType1Code:
		if typedDest == nil {
			return errors.New("nil pointer... in unmarshalling common.ExchangeRateType1Code data for" + docPath)
		}
	...
	case *common.PaymentMethod3Code:
		if typedDest == nil {
			return errors.New("nil pointer... in unmarshalling common.PaymentMethod3Code data for" + docPath)
		}
