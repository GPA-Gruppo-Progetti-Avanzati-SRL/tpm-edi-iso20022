...
func copy2DestNode(docPath string, dest, src interface{}, options *SetOpOptions) error {
	...
	case **CategoryPurpose1Choice:
		...
		return err
	case **Cheque6:
		if typedStruct, ok := src.(Cheque6); ok {
			*typedDest = &typedStruct
		} else {
			err = fmt.Errorf("value of type %T cannot be assigned", src)
		}
	...
	case **CreditorReferenceType2:
		...
		return err
	case **CustomerCreditTransferInitiationV03:
		if typedStruct, ok := src.(CustomerCreditTransferInitiationV03); ok {
			*typedDest = &typedStruct
		} else {
			err = fmt.Errorf("value of type %T cannot be assigned", src)
		}
	...
	case **EquivalentAmount2:
		...
		return err
	case **ExchangeRateInformation1:
		if typedStruct, ok := src.(ExchangeRateInformation1); ok {
			*typedDest = &typedStruct
		} else {
			err = fmt.Errorf("value of type %T cannot be assigned", src)
		}
	...
	case **GenericFinancialIdentification1:
		...
		return err
	case **GroupHeader32:
		if typedStruct, ok := src.(GroupHeader32); ok {
			*typedDest = &typedStruct
		} else {
			err = fmt.Errorf("value of type %T cannot be assigned", src)
		}
	...
	case **PaymentIdentification1:
		...
		return err
	case **PaymentTypeInformation19:
		if typedStruct, ok := src.(PaymentTypeInformation19); ok {
			*typedDest = &typedStruct
		} else {
			err = fmt.Errorf("value of type %T cannot be assigned", src)
		}
	...
	case *[]Authorisation1Choice:
		...
		return err
	case *CreditTransferTransactionInformation10:
		if typedStruct, ok := src.(CreditTransferTransactionInformation10); ok {
			*typedDest = typedStruct
		} else {
			err = fmt.Errorf("value of type %T cannot be assigned", src)
		}
	...
	case *[]InstructionForCreditorAgent1:
		...
		return err
	case *PaymentInstructionInformation3:
		if typedStruct, ok := src.(PaymentInstructionInformation3); ok {
			*typedDest = typedStruct
		} else {
			err = fmt.Errorf("value of type %T cannot be assigned", src)
		}
...
func (d *Document) ClearNode(path string, opts ...SetOpOption) error {
	const semLogContext = "pain_001_001_03::clear-node"
