...
// IsValid checks if Cheque6 is valid
func (s Cheque6) IsValid(optional bool) bool {
...
// IsValid checks if GroupHeader32 is valid
func (s GroupHeader32) IsValid(optional bool) bool {
...
// IsValid checks if CustomerCreditTransferInitiationV03 is valid
func (s CustomerCreditTransferInitiationV03) IsValid(optional bool) bool {
...
// IsValid checks if PaymentTypeInformation19 is valid
func (s PaymentTypeInformation19) IsValid(optional bool) bool {
...
// IsValid checks if ExchangeRateInformation1 is valid
func (s ExchangeRateInformation1) IsValid(optional bool) bool {

	valid := true
	valid = valid && s.XchgRate.IsValid(true)
	valid = valid && s.RateTp.IsValid(true)
...
// IsValid checks if CreditTransferTransactionInformation10 is valid
func (s CreditTransferTransactionInformation10) IsValid(optional bool) bool {
	...
	valid = valid && s.Amt.IsValid(false)
	valid = valid && (s.XchgRateInf == nil || (s.XchgRateInf != nil && s.XchgRateInf.IsValid(true)))
	...
	valid = valid && (s.IntrmyAgt1Acct == nil || (s.IntrmyAgt1Acct != nil && s.IntrmyAgt1Acct.IsValid(true)))

	valid = valid && (s.IntrmyAgt2 == nil || (s.IntrmyAgt2 != nil && s.IntrmyAgt2.IsValid(true)))

	valid = valid && (s.IntrmyAgt2Acct == nil || (s.IntrmyAgt2Acct != nil && s.IntrmyAgt2Acct.IsValid(true)))

	valid = valid && (s.IntrmyAgt3 == nil || (s.IntrmyAgt3 != nil && s.IntrmyAgt3.IsValid(true)))

	valid = valid && (s.IntrmyAgt3Acct == nil || (s.IntrmyAgt3Acct != nil && s.IntrmyAgt3Acct.IsValid(true)))
	...
	valid = valid && s.InstrForDbtrAgt.IsValid(true)
...
// IsValid checks if PaymentInstructionInformation3 is valid
func (s PaymentInstructionInformation3) IsValid(optional bool) bool {
	...
	valid = valid && s.PoolgAdjstmntDt.IsValid(true)
	valid = valid && s.Dbtr.IsValid(false)
	valid = valid && s.DbtrAcct.IsValid(false)
	...
	if len(s.CdtTrfTxInf) == 0 {
		valid = false
	}
	for j := 0; j < len(s.CdtTrfTxInf); j++ {
		valid = valid && s.CdtTrfTxInf[j].IsValid(false)
	}
