...
const (
	Max70TextZero      = ""
	Max70TextSample    = "oJnNPGsiuzytMOJPatwtPilfsfykSBGplhx"
	Max70TextLength    = 0
...
const (
	...
	ExternalAccountIdentification1CodeSample    = "tx"
...
const (
	...
	ExternalServiceLevel1CodeSample    = "VS"
...
const (
	...
	ExternalCategoryPurpose1CodeSample    = "Gp"
...
const (
	...
	ExternalPersonIdentification1CodeSample    = "qa"
...
const (
	Max128TextZero      = ""
	Max128TextSample    = "BRgAvzLXqzRrrUIYvaIujDpHYjxeUBrVfdwUzWHRihFDPRHBMuEWmaNvhHLITWJc"
	Max128TextLength    = 0
...
const (
	BICIdentifierZero   = ""
	BICIdentifierSample = "XMLFFQU044U"
)
...
const (
	...
	ExternalOrganisationIdentification1CodeSample    = "JK"
...
const (
	Max34TextZero      = ""
	Max34TextSample    = "zJsRPeJbpTqWPUlWA"
	Max34TextLength    = 0
...
const (
	Max35TextZero      = ""
	Max35TextSample    = "cidRlufmYWddEktBDr"
	Max35TextLength    = 0
...
const (
	...
	ActiveOrHistoricCurrencyCodeSample = "MCB"
)
...
const (
	...
	ExternalFinancialInstitutionIdentification1CodeSample    = "WM"
...
const (
	...
	AnyBICIdentifierSample = "KPGRFNRN0X7"
)
...
const (
	Max2048TextZero      = ""
	Max2048TextSample    = ""
	Max2048TextLength    = 0
...
const (
	...
	IBAN2007IdentifierSample = "UK52UnI5"
)
...
const (
	Max1025TextZero      = ""
	Max1025TextSample    = ""
	Max1025TextLength    = 0
...
const (
	Max140TextZero      = ""
	Max140TextSample    = "jcDxWEITHgqlDYhLFJMOcTZZFWapmAOnXsexQFSvTVoWpQQtMnMOzQQIvZvysnXgPLZTnL"
	Max140TextLength    = 0
...
const (
	...
	ExternalLocalInstrument1CodeSample    = "AfGypnykBponFugFaM"
