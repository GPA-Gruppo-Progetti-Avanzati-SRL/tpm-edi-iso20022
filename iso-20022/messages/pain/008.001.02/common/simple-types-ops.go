...
const (
	BICIdentifierZero   = ""
	BICIdentifierSample = "JYOIEXJP8ZU"
)
...
const (
	...
	ExternalFinancialInstitutionIdentification1CodeSample    = "wt"
...
const (
	Max35TextZero      = ""
	Max35TextSample    = "PilfsfykSBGplhxtxV"
	Max35TextLength    = 0
...
const (
	...
	ActiveOrHistoricCurrencyCodeSample = "IOK"
)
...
const (
	Max70TextZero      = ""
	Max70TextSample    = "SGpqaJaBRgAvzLXqzRrrUIYvaIujDpHYjxe"
	Max70TextLength    = 0
...
const (
	...
	ExternalOrganisationIdentification1CodeSample    = "UB"
...
const (
	...
	ExternalServiceLevel1CodeSample    = "fd"
...
const (
	Max140TextZero      = ""
	Max140TextSample    = "FDPRHBMuEWmaNvhHLITWJcJKzJsRPeJbpTqWPUlWAcidRlufmYWddEktBDrWMYZTPdmDAV"
	Max140TextLength    = 0
...
const (
	...
	ExternalPersonIdentification1CodeSample    = "Cu"
...
const (
	...
	ExternalAccountIdentification1CodeSample    = "vQ"
...
const (
	Max128TextZero      = ""
	Max128TextSample    = "utLDKFBGRxnyDNYuRKWsmZnOYgSLPSsuMMmvYmaFEjLgSvndTeranxGMNCcCdlEB"
	Max128TextLength    = 0
...
const (
	Max34TextZero      = ""
	Max34TextSample    = "xqrgAieJuFVZUsgPm"
	Max34TextLength    = 0
...
const (
	...
	ExternalClearingSystemIdentification1CodeSample    = "weL"
...
const (
	...
	AnyBICIdentifierSample = "XRCBWZOU"
)
...
const (
	Max1025TextZero      = ""
	Max1025TextSample    = ""
	Max1025TextLength    = 0
...
const (
	Max2048TextZero      = ""
	Max2048TextSample    = ""
	Max2048TextLength    = 0
...
const (
	...
	IBAN2007IdentifierSample = "UW58Duppn7U0"
)
