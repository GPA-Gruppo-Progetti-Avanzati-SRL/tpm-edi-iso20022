...
const (
	...
	ExternalClearingSystemIdentification1CodeSample    = "oJn"
...
const (
	...
	ExternalFinancialInstitutionIdentification1CodeSample    = "NP"
...
const (
	...
	ActiveOrHistoricCurrencyCodeSample = "PKN"
)
...
const (
	Max140TextZero      = ""
	Max140TextSample    = "MOJPatwtPilfsfykSBGplhxtxVSGpqaJaBRgAvzLXqzRrrUIYvaIujDpHYjxeUBrVfdwUz"
	Max140TextLength    = 0
...
const (
	...
	AnyBICIdentifierSample = "VYBIBH75ALE"
)
...
const (
	Max34TextZero      = ""
	Max34TextSample    = "WHRihFDPRHBMuEWma"
	Max34TextLength    = 0
...
const (
	Max1025TextZero      = ""
	Max1025TextSample    = ""
	Max1025TextLength    = 0
...
const (
	...
	ExternalOrganisationIdentification1CodeSample    = "Wm"
...
const (
	...
	ExternalServiceLevel1CodeSample    = "Rn"
...
const (
	Max70TextZero      = ""
	Max70TextSample    = "cQZpTAzceEsIpdYbrhfkVRdPhRXJzEKTBNC"
	Max70TextLength    = 0
...
const (
	BICIdentifierZero   = ""
	BICIdentifierSample = "TTHSLOVN2WB"
)
...
const (
	...
	ExternalCategoryPurpose1CodeSample    = "vo"
...
const (
	...
	IBAN2007IdentifierSample = "ZS96C0P21Sn"
)
...
const (
	Max35TextZero      = ""
	Max35TextSample    = "NhSeFRvuKeklvsHwab"
	Max35TextLength    = 0
...
const (
	Max128TextZero      = ""
	Max128TextSample    = "ufMjYxuvCIeoMjxivfYHKXcwedxkRvEookKzpacqgBiXejXjTJPhMQsmGzinFnyU"
	Max128TextLength    = 0
...
const (
	...
	ExternalLocalInstrument1CodeSample    = "VhVOydnINYczGVyZhB"
...
const (
	Max2048TextZero      = ""
	Max2048TextSample    = ""
	Max2048TextLength    = 0
...
const (
	...
	ExternalAccountIdentification1CodeSample    = "pv"
...
const (
	...
	ExternalPersonIdentification1CodeSample    = "gh"
