...
const (
	Max35TextZero      = ""
	Max35TextSample    = "oJnNPGsiuzytMOJPat"
	Max35TextLength    = 0
...
const (
	...
	Max15NumericTextSample = "1916103"
)
...
const (
	Max2048TextZero      = ""
	Max2048TextSample    = ""
	Max2048TextLength    = 0
...
const (
	...
	ExternalClearingSystemIdentification1CodeSample    = "coS"
...
const (
	...
	AnyBICIdentifierSample = "XHBZREX7EH0"
)
...
const (
	...
	ExternalAccountIdentification1CodeSample    = "KF"
...
const (
	Max1025TextZero      = ""
	Max1025TextSample    = ""
	Max1025TextLength    = 0
...
const (
	...
	ExternalLocalInstrument1CodeSample    = "DtAIhVqjQdfuwMFhuN"
...
const (
	Max34TextZero      = ""
	Max34TextSample    = "IjQYGTeIzlHVLBSME"
	Max34TextLength    = 0
...
const (
	Max140TextZero      = ""
	Max140TextSample    = "FGHRBYTYpySblEWkdaiqYPvySaTkOBngwczeRvNonCngObQiLPJINEKzHKmJBWSEmIYVET"
	Max140TextLength    = 0
...
const (
	...
	ExternalPersonIdentification1CodeSample    = "dm"
...
const (
	...
	ActiveOrHistoricCurrencyCodeSample = "YTE"
)
...
const (
	...
	ExternalOrganisationIdentification1CodeSample    = "py"
...
const (
	...
	ExternalFinancialInstitutionIdentification1CodeSample    = "Dv"
...
const (
	Max70TextZero      = ""
	Max70TextSample    = "fwRbnAOSHNYXsjcDxWEITHgqlDYhLFJMOcT"
	Max70TextLength    = 0
...
const (
	BICIdentifierZero   = ""
	BICIdentifierSample = "HSOYXNNL0RF"
)
...
const (
	Max128TextZero      = ""
	Max128TextSample    = "OnXsexQFSvTVoWpQQtMnMOzQQIvZvysnXgPLZTnLDrwaxkScPbAfGypnykBponFu"
	Max128TextLength    = 0
...
const (
	...
	IBAN2007IdentifierSample = "VR06Y9AKOef25a"
)
...
const (
	...
	ExternalServiceLevel1CodeSample    = "pv"
...
const (
	...
	ExternalCategoryPurpose1CodeSample    = "gh"
