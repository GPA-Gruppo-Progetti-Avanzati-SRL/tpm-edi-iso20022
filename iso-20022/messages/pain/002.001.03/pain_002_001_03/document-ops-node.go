...
func copy2DestNode(docPath string, dest, src interface{}, options *SetOpOptions) error {
	...
	case **AmendmentInformationDetails6:
		...
		return err
	case **AmountType3Choice:
		if typedStruct, ok := src.(AmountType3Choice); ok {
			*typedDest = &typedStruct
		} else {
			err = fmt.Errorf("value of type %T cannot be assigned", src)
		}
	...
	case **CreditorReferenceType2:
		...
		return err
	case **CustomerPaymentStatusReportV03:
		if typedStruct, ok := src.(CustomerPaymentStatusReportV03); ok {
			*typedDest = &typedStruct
		} else {
			err = fmt.Errorf("value of type %T cannot be assigned", src)
		}
	...
	case **GenericFinancialIdentification1:
		...
		return err
	case **GroupHeader36:
		if typedStruct, ok := src.(GroupHeader36); ok {
			*typedDest = &typedStruct
		} else {
			err = fmt.Errorf("value of type %T cannot be assigned", src)
		}
	...
	case **OrganisationIdentificationSchemeName1Choice:
		...
		return err
	case **OriginalGroupInformation20:
		if typedStruct, ok := src.(OriginalGroupInformation20); ok {
			*typedDest = &typedStruct
		} else {
			err = fmt.Errorf("value of type %T cannot be assigned", src)
		}
		...
		return err
	case **OriginalTransactionReference13:
		if typedStruct, ok := src.(OriginalTransactionReference13); ok {
			*typedDest = &typedStruct
		} else {
			err = fmt.Errorf("value of type %T cannot be assigned", src)
		}
	...
	case **PartyIdentification32:
		...
		return err
	case **PaymentTypeInformation22:
		if typedStruct, ok := src.(PaymentTypeInformation22); ok {
			*typedDest = &typedStruct
		} else {
			err = fmt.Errorf("value of type %T cannot be assigned", src)
		}
	...
	case **ServiceLevel8Choice:
		...
		return err
	case **SettlementInformation13:
		if typedStruct, ok := src.(SettlementInformation13); ok {
			*typedDest = &typedStruct
		} else {
			err = fmt.Errorf("value of type %T cannot be assigned", src)
		}
	...
	case **StatusReason6Choice:
		...
		return err
	case **ChargesInformation5:
		if typedStruct, ok := src.(ChargesInformation5); ok {
			*typedDest = &typedStruct
		} else {
			err = fmt.Errorf("value of type %T cannot be assigned", src)
		}
	...
	case **GenericPersonIdentification1:
		...
		return err
	case **NumberOfTransactionsPerStatus3:
		if typedStruct, ok := src.(NumberOfTransactionsPerStatus3); ok {
			*typedDest = &typedStruct
		} else {
			err = fmt.Errorf("value of type %T cannot be assigned", src)
		}
		...
		return err
	case **OriginalPaymentInformation1:
		if typedStruct, ok := src.(OriginalPaymentInformation1); ok {
			*typedDest = &typedStruct
		} else {
			err = fmt.Errorf("value of type %T cannot be assigned", src)
		}
		...
		return err
	case **PaymentTransactionInformation25:
		if typedStruct, ok := src.(PaymentTransactionInformation25); ok {
			*typedDest = &typedStruct
		} else {
			err = fmt.Errorf("value of type %T cannot be assigned", src)
		}
	...
	case **ReferredDocumentInformation3:
		...
		return err
	case **StatusReasonInformation8:
		if typedStruct, ok := src.(StatusReasonInformation8); ok {
			*typedDest = &typedStruct
		} else {
			err = fmt.Errorf("value of type %T cannot be assigned", src)
		}
...
func (d *Document) ClearNode(path string, opts ...SetOpOption) error {
	const semLogContext = "pain_002_001_03::clear-node"
