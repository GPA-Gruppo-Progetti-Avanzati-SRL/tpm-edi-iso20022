...
const (
	...
	ExternalCashClearingSystem1CodeSample    = "oJ"
...
const (
	...
	ActiveOrHistoricCurrencyCodeSample = "MOC"
)
...
const (
	...
	IBAN2007IdentifierSample = "TW97yg"
)
...
const (
	Max70TextZero      = ""
	Max70TextSample    = "BrVfdwUzWHRihFDPRHBMuEWmaNvhHLITWJc"
	Max70TextLength    = 0
...
const (
	...
	ExternalLocalInstrument1CodeSample    = "zJsRPeJbpTqWPUlWAc"
...
const (
	...
	ExternalClearingSystemIdentification1CodeSample    = "idR"
...
const (
	Max1025TextZero      = ""
	Max1025TextSample    = ""
	Max1025TextLength    = 0
...
const (
	...
	Max15NumericTextSample = "87546090"
)
...
const (
	...
	ExternalServiceLevel1CodeSample    = "EK"
...
const (
	...
	AnyBICIdentifierSample = "PLKSMJ5Z"
)
...
const (
	Max2048TextZero      = ""
	Max2048TextSample    = ""
	Max2048TextLength    = 0
...
const (
	Max34TextZero      = ""
	Max34TextSample    = "gqlDYhLFJMOcTZZFW"
	Max34TextLength    = 0
...
const (
	...
	ExternalAccountIdentification1CodeSample    = "ap"
...
const (
	...
	ExternalStatusReason1CodeSample    = "On"
...
const (
	Max105TextZero      = ""
	Max105TextSample    = "XsexQFSvTVoWpQQtMnMOzQQIvZvysnXgPLZTnLDrwaxkScPbAfGyp"
	Max105TextLength    = 0
...
const (
	...
	ExternalPersonIdentification1CodeSample    = "ny"
...
const (
	...
	ExternalFinancialInstitutionIdentification1CodeSample    = "kB"
