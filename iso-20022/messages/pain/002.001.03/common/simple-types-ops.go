...
const (
	Max2048TextZero      = ""
	Max2048TextSample    = ""
	Max2048TextLength    = 0
...
const (
	...
	ExternalServiceLevel1CodeSample    = "jR"
...
const (
	...
	Max15NumericTextSample = "5564438"
)
...
const (
	...
	ExternalFinancialInstitutionIdentification1CodeSample    = "Mx"
...
const (
	Max1025TextZero      = ""
	Max1025TextSample    = ""
	Max1025TextLength    = 0
...
const (
	...
	ExternalPersonIdentification1CodeSample    = "GT"
...
const (
	...
	ActiveOrHistoricCurrencyCodeSample = "DXJ"
)
...
const (
	BICIdentifierZero   = ""
	BICIdentifierSample = "DHGJBSOQYV2"
)
...
const (
	Max105TextZero      = ""
	Max105TextSample    = "zlHVLBSMEFGHRBYTYpySblEWkdaiqYPvySaTkOBngwczeRvNonCng"
	Max105TextLength    = 0
...
const (
	...
	ExternalStatusReason1CodeSample    = "Ob"
...
const (
	...
	ExternalCashClearingSystem1CodeSample    = "Qi"
...
const (
	Max35TextZero      = ""
	Max35TextSample    = "LPJINEKzHKmJBWSEmI"
	Max35TextLength    = 0
...
const (
	Max140TextZero      = ""
	Max140TextSample    = "YVETdmMapyDvfwRbnAOSHNYXsjcDxWEITHgqlDYhLFJMOcTZZFWapmAOnXsexQFSvTVoWp"
	Max140TextLength    = 0
...
const (
	...
	ExternalClearingSystemIdentification1CodeSample    = "QQt"
...
const (
	Max34TextZero      = ""
	Max34TextSample    = "MnMOzQQIvZvysnXgP"
	Max34TextLength    = 0
...
const (
	...
	ExternalCategoryPurpose1CodeSample    = "LZ"
...
const (
	...
	ExternalOrganisationIdentification1CodeSample    = "Tn"
...
const (
	...
	ExternalLocalInstrument1CodeSample    = "LDrwaxkScPbAfGypny"
...
const (
	...
	AnyBICIdentifierSample = "XXTGEGE5"
)
...
const (
	...
	IBAN2007IdentifierSample = "OL25OSjWAAO7j"
)
...
const (
	...
	ExternalAccountIdentification1CodeSample    = "kB"
