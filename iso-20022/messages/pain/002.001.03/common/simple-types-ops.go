...
const (
	Max1025TextZero      = ""
	Max1025TextSample    = ""
	Max1025TextLength    = 0
...
const (
	...
	ExternalAccountIdentification1CodeSample    = "VJ"
...
const (
	...
	ExternalPersonIdentification1CodeSample    = "JT"
...
const (
	...
	IBAN2007IdentifierSample = "GC00N7iN1jKWHO"
)
...
const (
	...
	ExternalCashClearingSystem1CodeSample    = "Vs"
...
const (
	Max140TextZero      = ""
	Max140TextSample    = "rIgXXlvECpbDIWegrUuUYynIaqJjgVXQtZptcLZIVmypNpLbbaxHYDmKrYnEbqbvWLjZZA"
	Max140TextLength    = 0
...
const (
	Max35TextZero      = ""
	Max35TextSample    = "HQHWIGRYPwqfeXSWmR"
	Max35TextLength    = 0
...
const (
	...
	ExternalServiceLevel1CodeSample    = "QZ"
...
const (
	...
	ExternalLocalInstrument1CodeSample    = "pTAzceEsIpdYbrhfkV"
...
const (
	...
	ExternalClearingSystemIdentification1CodeSample    = "RdP"
...
const (
	...
	ExternalStatusReason1CodeSample    = "hR"
...
const (
	Max2048TextZero      = ""
	Max2048TextSample    = ""
	Max2048TextLength    = 0
...
const (
	Max105TextZero      = ""
	Max105TextSample    = "TdmMapyDvfwRbnAOSHNYXsjcDxWEITHgqlDYhLFJMOcTZZFWapmAO"
	Max105TextLength    = 0
...
const (
	...
	ActiveOrHistoricCurrencyCodeSample = "OIH"
)
...
const (
	Max70TextZero      = ""
	Max70TextSample    = "nXsexQFSvTVoWpQQtMnMOzQQIvZvysnXgPL"
	Max70TextLength    = 0
...
const (
	...
	ExternalOrganisationIdentification1CodeSample    = "nL"
...
const (
	...
	AnyBICIdentifierSample = "PAGIGDLJ"
)
...
const (
	...
	ExternalCategoryPurpose1CodeSample    = "Dr"
...
const (
	Max34TextZero      = ""
	Max34TextSample    = "waxkScPbAfGypnykB"
	Max34TextLength    = 0
