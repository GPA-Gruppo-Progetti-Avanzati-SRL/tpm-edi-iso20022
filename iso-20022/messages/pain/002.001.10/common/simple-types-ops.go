...
const (
	LEIIdentifierZero   = ""
	LEIIdentifierSample = "C7JPT0P17PASPXNMCC94"
)
...
const (
	...
	ExternalFinancialInstitutionIdentification1CodeSample    = "oJ"
...
const (
	...
	ExternalDiscountAmountType1CodeSample    = "nN"
...
const (
	Max140TextZero      = ""
	Max140TextSample    = "PGsiuzytMOJPatwtPilfsfykSBGplhxtxVSGpqaJaBRgAvzLXqzRrrUIYvaIujDpHYjxeU"
	Max140TextLength    = 0
...
const (
	...
	Exact4AlphaNumericTextSample = "d30U"
)
...
const (
	...
	ExternalMandateSetupReason1CodeSample    = "Br"
...
const (
	Max2048TextZero      = ""
	Max2048TextSample    = ""
	Max2048TextLength    = 0
...
const (
	Max105TextZero      = ""
	Max105TextSample    = "fcXVutzuIkhdUMOniOqWYIJMqLchMkCJZHSenoYIFnHZyTzEfMSdh"
	Max105TextLength    = 0
...
const (
	...
	ExternalDocumentLineType1CodeSample    = "Uv"
...
const (
	...
	Max15NumericTextSample = "91486970"
)
...
const (
	...
	ExternalPaymentGroupStatus1CodeSample    = "tM"
...
const (
	...
	ExternalAccountIdentification1CodeSample    = "Bl"
...
const (
	...
	ExternalCashAccountType1CodeSample    = "fU"
...
const (
	Max350TextZero      = ""
	Max350TextSample    = "oZYLEdqkoZCuTuRpLKzzuuFjTKIOTjSnLTFioYayJwBotODVVVIrFCqrhOGVehnNZfARfsBVGBRaHjfFcQtXovQyXbjAyWbspgheqXXumwlaMkvqgeVNsLyylTpEsGuymNstQzxPbmXGYPZRoCcAjYwjicELciiQYDuPezahlBGYsXs"
	Max350TextLength    = 0
...
const (
	...
	ExternalCashClearingSystem1CodeSample    = "Qy"
...
const (
	...
	ExternalServiceLevel1CodeSample    = "az"
...
const (
	...
	ExternalCategoryPurpose1CodeSample    = "OW"
...
const (
	...
	ExternalProxyAccountType1CodeSample    = "cr"
...
const (
	...
	IBAN2007IdentifierSample = "QY203R6Xq"
)
...
const (
	Max1025TextZero      = ""
	Max1025TextSample    = ""
	Max1025TextLength    = 0
...
const (
	Max70TextZero      = ""
	Max70TextSample    = "zcwgvmZkRAOUBuSLfMQxiKGQfgjgNtyljnt"
	Max70TextLength    = 0
...
const (
	...
	ExternalGarnishmentType1CodeSample    = "NW"
...
const (
	Max35TextZero      = ""
	Max35TextSample    = "XXYMdxTRsqOTDdeltI"
	Max35TextLength    = 0
...
const (
	...
	AnyBICDec2014IdentifierSample = "VBIHFVCOBD5"
)
...
const (
	...
	ExternalTaxAmountType1CodeSample    = "IB"
...
const (
	...
	UUIDv4IdentifierSample = "7140b5f8-8daa-4a1e-8190-aa9d287f6874"
)
...
const (
	...
	BICFIDec2014IdentifierSample = "ZU87UY2Y8FA"
)
...
const (
	...
	ExternalStatusReason1CodeSample    = "Zg"
...
const (
	...
	ExternalPaymentTransactionStatus1CodeSample    = "ZY"
...
const (
	...
	ActiveOrHistoricCurrencyCodeSample = "WVN"
)
...
const (
	...
	ExternalClearingSystemIdentification1CodeSample    = "JCj"
...
const (
	...
	ExternalLocalInstrument1CodeSample    = "hEHHskeVLOdmPbocRv"
...
const (
	Max34TextZero      = ""
	Max34TextSample    = "yaToaaLLczPeHYSnz"
	Max34TextLength    = 0
...
const (
	...
	ExternalPersonIdentification1CodeSample    = "kl"
...
const (
	Max128TextZero      = ""
	Max128TextSample    = "axZVdHppAFbHZnhPpTOSyMuzRWOXcuCUExoZFaXYKKDYXTCsqGamaruEhaxobcyv"
	Max128TextLength    = 0
