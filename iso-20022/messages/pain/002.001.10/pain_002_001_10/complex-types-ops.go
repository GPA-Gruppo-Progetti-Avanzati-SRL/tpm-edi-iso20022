...
// IsValid checks if GroupHeader86 is valid
func (s GroupHeader86) IsValid(optional bool) bool {
...
// IsValid checks if OriginalGroupHeader17 is valid
func (s OriginalGroupHeader17) IsValid(optional bool) bool {
...
// IsValid checks if CustomerPaymentStatusReportV10 is valid
func (s CustomerPaymentStatusReportV10) IsValid(optional bool) bool {
...
// IsValid checks if CurrencyExchange13 is valid
func (s CurrencyExchange13) IsValid(optional bool) bool {

	valid := true
	valid = valid && s.SrcCcy.IsValid(false)
	valid = valid && s.TrgtCcy.IsValid(false)
...
// IsValid checks if TrackerRecord1 is valid
func (s TrackerRecord1) IsValid(optional bool) bool {

	valid := true
	valid = valid && s.Agt != nil && s.Agt.IsValid(false)

	valid = valid && s.ChrgBr.IsValid(true)
	valid = valid && (s.ChrgsAmt == nil || (s.ChrgsAmt != nil && s.ChrgsAmt.IsValid(true)))

	valid = valid && (s.XchgRateData == nil || (s.XchgRateData != nil && s.XchgRateData.IsValid(true)))
...
// IsValid checks if TrackerData1 is valid
func (s TrackerData1) IsValid(optional bool) bool {

	valid := true
	valid = valid && s.ConfdDt != nil && s.ConfdDt.IsValid(false)

	valid = valid && s.ConfdAmt != nil && s.ConfdAmt.IsValid(false)

	if len(s.TrckrRcrd) == 0 {
		valid = false
	}
	for j := 0; j < len(s.TrckrRcrd); j++ {
		valid = valid && s.TrckrRcrd[j].IsValid(false)
	}
...
// IsValid checks if OriginalPaymentInstruction32 is valid
func (s OriginalPaymentInstruction32) IsValid(optional bool) bool {
...
// IsValid checks if PaymentTransaction105 is valid
func (s PaymentTransaction105) IsValid(optional bool) bool {
	...
	valid = valid && (s.TrckrData == nil || (s.TrckrData != nil && s.TrckrData.IsValid(true)))
