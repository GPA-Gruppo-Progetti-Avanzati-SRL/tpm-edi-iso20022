...
const (
	...
	ExternalReturnReason1CodeSample    = "oJ"
...
const (
	...
	ExternalPersonIdentification1CodeSample    = "nN"
...
const (
	Max500TextZero      = ""
	Max500TextSample    = "siuzytMOJPatwtPilfsfykSBGplhxtxVSGpqaJaBRgAvzLXqzRrrUIYvaIujDpHYjxeUBrVfdwUzWHRihFDPRHBMuEWmaNvhHLITWJcJKzJsRPeJbpTqWPUlWAcidRlufmYWddEktBDrWMYZTPdmDAVCuvQutLDKFBGRxnyDNYuRKWsmZnOYgSLPSsuMMmvYmaFEjLgSvndTeranxGMNCcCdlEBYqxqrgAieJuFVZUsgPmweLRmsdTIwtL"
	Max500TextLength    = 0
...
const (
	...
	ActiveOrHistoricCurrencyCodeSample = "KBI"
)
...
const (
	Max34TextZero      = ""
	Max34TextSample    = "UDqoBSNtPRViLXLCr"
	Max34TextLength    = 0
...
const (
	Max105TextZero      = ""
	Max105TextSample    = "SAZCjxTCaZnfHRhEbbvlLkCbvOlRrOWJFNwNQBqyozKVGeninyrTg"
	Max105TextLength    = 0
...
const (
	...
	ExternalBalanceSubType1CodeSample    = "qu"
...
const (
	...
	ExternalOrganisationIdentification1CodeSample    = "bN"
...
const (
	...
	ExternalClearingSystemIdentification1CodeSample    = "iIz"
...
const (
	...
	ExternalReportingSource1CodeSample    = "EZ"
...
const (
	...
	IBAN2007IdentifierSample = "KO52VhwXHjXLJ"
)
...
const (
	...
	ExternalAccountIdentification1CodeSample    = "OD"
...
const (
	BICIdentifierZero   = ""
	BICIdentifierSample = "UAMUISV0G7Y"
)
...
const (
	Max70TextZero      = ""
	Max70TextSample    = "nRKcTqZThaTJmRVAClOEaCEmEUmEtNTDVBb"
	Max70TextLength    = 0
...
const (
	...
	AnyBICIdentifierSample = "WZAPKSAJ9K4"
)
...
const (
	...
	ExternalTechnicalInputChannel1CodeSample    = "vM"
...
const (
	ISINIdentifierZero   = ""
	ISINIdentifierSample = "CH23CKYU8VI9"
)
...
const (
	...
	ExternalFinancialInstitutionIdentification1CodeSample    = "Bt"
...
const (
	Max35TextZero      = ""
	Max35TextSample    = "QBeDBVyDFfPWGaZQnt"
	Max35TextLength    = 0
...
const (
	...
	Max15PlusSignedNumericTextSample = "+4989"
)
...
const (
	Max2048TextZero      = ""
	Max2048TextSample    = ""
	Max2048TextLength    = 0
...
const (
	...
	ExternalBankTransactionSubFamily1CodeSample    = "gx"
...
const (
	...
	ExternalBankTransactionFamily1CodeSample    = "NQ"
...
const (
	...
	Max15NumericTextSample = "47105572"
)
...
const (
	...
	ExternalBankTransactionDomain1CodeSample    = "Pp"
...
const (
	Max140TextZero      = ""
	Max140TextSample    = "RiWmNuFOPctLBlMZxcxWxtuKOMWJPKLdPagMDpbVTfGYQeuDWBbAsCNeGzZKpmgINTkian"
	Max140TextLength    = 0
